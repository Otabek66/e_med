...
class FontStyles {
  ...
  static const TextStyle headline3blue = TextStyle(
      fontSize: FontSize.medium,
      fontWeight: FontWeight.bold,
      color: ColorConst.kPrimaryColor);
  static const TextStyle headline3sblue = TextStyle(
      fontSize: FontSize.medium,
      color: ColorConst.kPrimaryColor,
      fontWeight: FWconst.bold);
  static const TextStyle headline3s =
      TextStyle(fontSize: FontSize.medium, fontWeight: FontWeight.bold);
  static const TextStyle headline4s = TextStyle(fontSize: FontSize.medium);
  static const TextStyle headline4sbold =
      TextStyle(fontSize: FontSize.medium, fontWeight: FWconst.bold);
  ...
  static const TextStyle headline52 =
      TextStyle(fontSize: FontSize.medium2, color: ColorConst.blackfortext);
